...
async function setupSwagger(app: INestApplication) {
  ...
  const fullDeviceDocs = SwaggerModule.createDocument(app, config, {
    include: [DeliveryModule, DeployModule, DeviceModule, GetMapModule, Login, OfferingModule, RulesModule, BandwidthModule],
  });
  ...
  const fullDocumentV2 = SwaggerModule.createDocument(app, configV2, {
    include: [Login, DeviceModule, OfferingModule, DeliveryModule, DeployModule, BandwidthModule],
  });
  ...
  const fullDocumentV2Auth = SwaggerModule.createDocument(app, configV2Auth, {
    include: [DeviceModule, OfferingModule, DeliveryModule, DeployModule, BandwidthModule],
  });
